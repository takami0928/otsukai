...
export const products: Product[] = [
  ...
  { id: 'maitake', name: '舞茸', categoryId: 'vegetables', defaultQuantity: 1, unit: 'パック', icon: '🍄', sortOrder: 114 },
  { id: 'cucumber', name: 'きゅうり', categoryId: 'vegetables', defaultQuantity: 1, unit: '袋', icon: '🥒', sortOrder: 115 },
  { id: 'tomato', name: 'トマト', categoryId: 'vegetables', defaultQuantity: 1, unit: 'パック', icon: '🍅', sortOrder: 116 },
  { id: 'green-pepper', name: 'ピーマン', categoryId: 'vegetables', defaultQuantity: 1, unit: '袋', icon: '🫑', sortOrder: 117 },
  { id: 'daikon', name: '大根', categoryId: 'vegetables', defaultQuantity: 1, unit: '本', icon: '🥕', sortOrder: 118 },
  { id: 'sweet-potato', name: 'さつまいも', categoryId: 'vegetables', defaultQuantity: 1, unit: '袋', icon: '🍠', sortOrder: 119 },
  { id: 'pumpkin', name: 'かぼちゃ', categoryId: 'vegetables', defaultQuantity: 1, unit: '個', icon: '🎃', sortOrder: 120 },
  { id: 'eggplant', name: 'なす', categoryId: 'vegetables', defaultQuantity: 1, unit: '袋', icon: '🍆', sortOrder: 121 },
  { id: 'burdock', name: 'ごぼう', categoryId: 'vegetables', defaultQuantity: 1, unit: '本', icon: '🥕', sortOrder: 122 },
  ...
  { id: 'pucchin-pudding', name: 'プッチンプリン', categoryId: 'eggs-dairy', defaultQuantity: 1, unit: '個', icon: '🍮', sortOrder: 707 },
